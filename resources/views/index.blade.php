...
<html lang="en">
  ...
  <body ng-app="MorAnimeList" ng-controller="homeCtrl">
  ...
  <header id="header">
    <div class="header-inner">
      <!-- Header image -->
      <img src="assets/images/llss-bg2.jpg" alt="img">
      <div class="header-overlay">
        <div class="header-content">
        <!-- Start header content slider -->
        <h2 class="header-slide">Anime is
          <span>Life</span>
          <span>Happiness</span>
          <span>Enjoyment</span>
        </h2>
        ...
        <!-- <div class="header-btn-area">
          <a class="knowmore-btn" href="#">View More</a>
        </div> -->
      </div>
      </div>      
    </div>
        ...
        <section id="home">
            <div class="row">
                ...
                <div class="welcome-area">
                    ...
                    <h2 class="tittle">Welcome to <span>MorAnimeList</span></h2>
                    <span class="tittle-line"></span>
                    <p>The world's largest scam website of Anime and Manga</p>
                    </div>
                    ...
                    <ul class="wc-table">
                        ...
                        <div class="single-wc-content wow fadeInUp">
                            ...
                            <h4 class="wc-tittle">Anime</h4>
                            <p>Anime is hand-drawn and computer animation originating from or associated with Japan.</p>
                        </div>
                        </li>
                        <li>
                        <div class="single-wc-content wow fadeInUp">
                            <span class="fa fa-sellsy wc-icon"></span>
                            <h4 class="wc-tittle">Manga</h4>
                            <p>Manga are comics or graphic novels created in Japan or by creators in the Japanese language, conforming to a style developed in Japan in the late 19th century.</p>
                        </div>
                        </li>
                        <li>
                        <div class="single-wc-content wow fadeInUp">
                            <span class="fa fa-sellsy wc-icon"></span>
                            <h4 class="wc-tittle">Favorites</h4>
                            <p>Create your personalized list from tens of thousands of titles on the world’s largest scam anime and manga database.</p>
                        </div>
                        </li>
                        <li>
                        <div class="single-wc-content wow fadeInUp">
                            <span class="fa fa-sellsy wc-icon"></span>
                            <h4 class="wc-tittle">Need to stay up to date?</h4>
  ...
  <section id="anime" style="background-color: white;">
    <div class="container">
      <div class="row">
        <div class="col-md-12" style=" margin-top: 70px;">
